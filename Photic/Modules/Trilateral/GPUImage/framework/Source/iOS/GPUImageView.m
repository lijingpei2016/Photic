...
//
//        NSLog(@"self->inputImageSize  w == %lf  h == %lf",self->inputImageSize.width,self->inputImageSize.height);
//        NSLog(@"self->bounds  w == %lf  h == %lf",self.bounds.size.width,self.bounds.size.height);
//
//
